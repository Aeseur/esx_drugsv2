...
AddEventHandler('esx_drugs:hasEnteredMarker', function(zone)
	...
	if zone == 'CrackDealer' then
		if crack_poochQTE >= 1 then
			CurrentAction     = zone
			CurrentActionMsg  = _U('press_sell_crack')
			CurrentActionData = {}
		end
	end
	----------------------------------------------------
	...
	------------------------------------------------------
	------------------------------------------------------
	if zone == 'MethlabField' then
		CurrentAction     = zone
		CurrentActionMsg  = _U('press_collect_methlab')
		CurrentActionData = {}
	end
	...
	if zone == 'LithiumField' then
		CurrentAction     = zone
		CurrentActionMsg  = _U('press_collect_lithium')
		CurrentActionData = {}
	end
	------------------------------------------------------
	------------------------------------------------------
	...
	---------------------------------------------------
	if zone == 'KetamineField' then
		CurrentAction     = zone
		CurrentActionMsg  = _U('press_collect_ketamine')
		CurrentActionData = {}
	end

	if zone == 'KetamineProcessing' then
		if ketamineQTE >= 5 then
			CurrentAction     = zone
			CurrentActionMsg  = _U('press_process_ketamine')
			CurrentActionData = {}
		end
	end

	if zone == 'KetamineDealer' then
		if ketamine_poochQTE >= 1 then
			CurrentAction     = zone
			CurrentActionMsg  = _U('press_sell_ketamine')
			CurrentActionData = {}
		end
	end
	---------------------------------------------------
	...
	----------------------------------------------------
	if zone == 'EcstasyField' then
		CurrentAction     = zone
		CurrentActionMsg  = _U('press_collect_ecstasy')
		CurrentActionData = {}
	end

	if zone == 'EcstasyProcessing' then
		if ecstasyQTE >= 5 then
			CurrentAction     = zone
	...
	if zone == 'EcstasyDealer' then
		if ecstasy_poochQTE >= 1 then
			CurrentAction     = zone
...
AddEventHandler('esx_drugs:hasExitedMarker', function(zone)
	...
	------------------------------------------------------
	------------------------------------------------------
	TriggerServerEvent('esx_drugs:stopHarvestMethlab')
	TriggerServerEvent('esx_drugs:stopHarvestAcetone')
	TriggerServerEvent('esx_drugs:stopHarvestLithium')
	------------------------------------------------------
	------------------------------------------------------
	...
	--------------------------------------------------
	TriggerServerEvent('esx_drugs:stopHarvestCrack')
	TriggerServerEvent('esx_drugs:stopTransformCrack')
	TriggerServerEvent('esx_drugs:stopSellCrack')
	TriggerServerEvent('esx_drugs:stopHarvestKetamine')
	TriggerServerEvent('esx_drugs:stopTransformKetamine')
	TriggerServerEvent('esx_drugs:stopSellKetamine')
	TriggerServerEvent('esx_drugs:stopHarvestEcstasy')
	TriggerServerEvent('esx_drugs:stopTransformEcstasy')
	TriggerServerEvent('esx_drugs:stopSellEcstasy')
	--------------------------------------------------
	TriggerServerEvent('esx_drugs:stopHarvestBillet')
	TriggerServerEvent('esx_drugs:stopTransformBillet')
	TriggerServerEvent('esx_drugs:stopSellBillet')
	--------------------------------------------------
...
AddEventHandler('esx_drugs:ReturnInventory', function(cokeNbr, cokepNbr, methNbr, methpNbr, weedNbr, weedpNbr, crackNbr, crackpNbr, ketamineNbr, ketaminepNbr, ecstasyNbr, ecstasypNbr, billetNbr, billetpNbr, opiumNbr, opiumpNbr, jobName, currentZone)
	cokeQTE	      = cokeNbr
	...
	ketamineQTE 	  = ketamineNbr
	ketamine_poochQTE = ketaminepNbr
	ecstasyQTE 	      = ecstasyNbr
	ecstasy_poochQTE  = ecstasypNbr
	---------------------------
	billetQTE	      = billetNbr
	billet_poochQTE   = billetpNbr
	---------------------------
	opiumQTE	   = opiumNbr
	...
	while true do
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, Keys['E']) then
				...
				------------------------------------------------------
				------------------------------------------------------
				elseif CurrentAction == 'MethlabField' then
					TriggerServerEvent('esx_drugs:startHarvestMethlab')
				elseif CurrentAction == 'AcetoneField' then
					TriggerServerEvent('esx_drugs:startHarvestAcetone')
				elseif CurrentAction == 'LithiumField' then
					TriggerServerEvent('esx_drugs:startHarvestLithium')
				------------------------------------------------------
				------------------------------------------------------
				...
				elseif CurrentAction == 'CrackField' then
					TriggerServerEvent('esx_drugs:startHarvestCrack')
				elseif CurrentAction == 'CrackProcessing' then
					TriggerServerEvent('esx_drugs:startTransformCrack')
				elseif CurrentAction == 'CrackDealer' then
					TriggerServerEvent('esx_drugs:startSellCrack')
				elseif CurrentAction == 'KetamineField' then
					TriggerServerEvent('esx_drugs:startHarvestKetamine')
				elseif CurrentAction == 'KetamineProcessing' then
					TriggerServerEvent('esx_drugs:startTransformKetamine')
				elseif CurrentAction == 'KetamineDealer' then
					TriggerServerEvent('esx_drugs:startSellKetamine')
				elseif CurrentAction == 'EcstasyField' then
					TriggerServerEvent('esx_drugs:startHarvestEcstasy')
				elseif CurrentAction == 'EcstasyProcessing' then
					TriggerServerEvent('esx_drugs:startTransformEcstasy')
				elseif CurrentAction == 'EcstasyDealer' then
					TriggerServerEvent('esx_drugs:startSellEcstasy')
				---------------------------------------------------------
				elseif CurrentAction == 'BilletField' then
					TriggerServerEvent('esx_drugs:startHarvestBillet')
				elseif CurrentAction == 'BilletProcessing' then
					TriggerServerEvent('esx_drugs:startTransformBillet')
				elseif CurrentAction == 'BilletDealer' then
					TriggerServerEvent('esx_drugs:startSellBillet')
				---------------------------------------------------------
